...
class APIClient:
    ...
    @allure.step("Make GET request http to {url}")
    ...
    @allure.step("Make POST request http to {url}")
    def post(
            self,
            url: URL | str,
            json : Any | None =None ,
    ...
    @allure.step("Make PATCH request http to {url}")
    ...
    @allure.step("Make DELETE request http to {url}")
